...
AutomaticEvents = Data(Automatic,:); % Extract all automatic events
ZeroEvents = (AutomaticEvents(:,3)==0); % Select all event that has 0 as the TTL code
...
ManData = Data(~Automatic,:);  % Get all events that are not automatic
